using Administration = HRMS.Administration.Pages;
...
[assembly: NavigationLink(9400, "Administr tion/User Management", typeof(Administration.UserPage), icon: "fa-users")]